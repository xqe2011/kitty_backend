...
@Module({
    imports: [ CatModule, CommentModule, ShopModule, UserModule, QRCodeModule ],
    controllers: [ CatController, CatPhotoController, CommentController, CommentsAreaController, ShopOrderController, UserController, ConsumeController ]
})
